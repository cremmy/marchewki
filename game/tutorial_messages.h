...
namespace Game
	...
	const std::string TUTORIAL_10="Postaw wie¿ê atakuj¹c¹ obszarowo (W) ko³o nory aby j¹ zniszczyæ. Pozb¹dŸ siê nór i zasadŸ marchewki na wszystkich polach aby wygraæ grê.\n...i to by by³o na tyle w kwestii podstaw gry. Wciœnij ESC i wróæ do menu g³ównego aby rozpocz¹æ zwyk³¹ grê. Menu pomoc zawiera szczegó³owe informacje o mechanice gry.";
	}
