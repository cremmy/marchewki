...
enum Rules
	...
	RULE_DRAIN_HP=              0x1<<2, // Gracz nie traci HP // TODO
	RULE_DRAIN_RESOURCES=       0x1<<3, // Wieże nie zużywają zasobów
	RULE_ENEMY_BUILD_TURRETS=   0x1<<4, // Nie pojawiają się kolejne gniazda wrogów // TODO
	...
	RULESET_EASY=               RULE_BUILDING_COST|RULE_ENEMY_SPAWN_UNITS|RULE_DRAIN_HP|RULE_DRAIN_RESOURCES|RULE_ENEMY_BUILD_TURRETS|RULE_ENEMY_PREFER_CARROTS,
	RULESET_MEDIUM=             RULE_BUILDING_COST|RULE_ENEMY_SPAWN_UNITS|RULE_DRAIN_HP|RULE_DRAIN_RESOURCES|RULE_ENEMY_BUILD_TURRETS|RULE_ENEMY_PREFER_CARROTS|                         RULE_PLAYER_STOMPS_CARROTS,
	RULESET_HARD=               RULE_BUILDING_COST|RULE_ENEMY_SPAWN_UNITS|RULE_DRAIN_HP|RULE_DRAIN_RESOURCES|RULE_ENEMY_BUILD_TURRETS|                          RULE_ENEMY_AVOID_TURRETS|RULE_PLAYER_STOMPS_CARROTS,
	};
